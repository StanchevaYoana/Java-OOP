...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        Vehicles car = new Car(Double.parseDouble(data[1]), Double.parseDouble(data[2]), Integer.parseInt(data[3]));
        data = reader.readLine().split("\\s+");
        Vehicles truck = new Truck(Double.parseDouble(data[1]), Double.parseDouble(data[2]), Integer.parseInt(data[3]));
        data = reader.readLine().split("\\s+");
        Vehicles bus = new Bus(Double.parseDouble(data[1]), Double.parseDouble(data[2]), Integer.parseInt(data[3]));
